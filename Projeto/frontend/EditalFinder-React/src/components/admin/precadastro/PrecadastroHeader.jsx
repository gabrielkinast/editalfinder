/**
 * Faixa superior do pré-cadastro: ações e metadados do projeto.
 */
...
export default function PrecadastroHeader({
  ...
  return (
    <header className="precad-header-prof">
      ...
      <div className="precad-header-actions">
        <button type="button" className="precad-btn precad-btn-ghost" onClick={onClose}>
          Fechar
        </button>
        {onPreviewPdf ? (
        ...
        <button type="button" className="precad-btn precad-btn-accent" onClick={onExportPdf}>
          Baixar PDF
        </button>
      </div>
    </header>
