...
- Execução: `2026-05-20T01:42:41Z`
- Modo: **apply**
- Fonte: `darpa_news`
- Wave: `—`
- Payload notícia: `D:\Computational_Physics\My Projects\edital\audit_reports_news_research\darpa_news_subset_valido\darpa_news_wave1_payload_noticia.json`
- Payload pesquisa: `D:\Computational_Physics\My Projects\edital\audit_reports_news_research\darpa_news_subset_valido\darpa_news_wave1_payload_pesquisa.json`
- Review (auditoria, não carregado): `D:\Computational_Physics\My Projects\edital\audit_reports_news_research\darpa_news_subset_valido\darpa_news_wave1_review_candidates.json`
- Diretório: `D:\Computational_Physics\My Projects\edital\audit_reports_news_research\darpa_news_subset_valido`

## Métricas

- total_noticia (input): **10**
- total_pesquisa (input): **0**
- would_upsert_noticia: **10**
- would_upsert_pesquisa: **0**
- inserted_noticia / updated_noticia: **0** / **10**
- inserted_pesquisa / updated_pesquisa: **0** / **0**
- skipped: **0**
- errors: **0**
- review_candidates_ignored: **0**
- arrays_normalized_count: **10**
