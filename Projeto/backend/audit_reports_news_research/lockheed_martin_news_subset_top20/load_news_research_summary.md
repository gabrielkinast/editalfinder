...
- Execução: `2026-05-20T01:42:19Z`
- Modo: **apply**
- Fonte: `lockheed_martin_news`
- Wave: `—`
- Payload notícia: `D:\Computational_Physics\My Projects\edital\audit_reports_news_research\lockheed_martin_news_subset_top20\standardized\lockheed_martin_news_standardized.json`
- Payload pesquisa: `D:\Computational_Physics\My Projects\edital\audit_reports_news_research\lockheed_martin_news_subset_top20\lockheed_martin_news_payload_pesquisa.json`
- Review (auditoria, não carregado): `D:\Computational_Physics\My Projects\edital\audit_reports_news_research\lockheed_martin_news_subset_top20\lockheed_martin_news_review_candidates.json`
- Diretório: `D:\Computational_Physics\My Projects\edital\audit_reports_news_research\lockheed_martin_news_subset_top20`

## Métricas

- total_noticia (input): **20**
- total_pesquisa (input): **0**
- would_upsert_noticia: **20**
- would_upsert_pesquisa: **0**
- inserted_noticia / updated_noticia: **0** / **20**
- inserted_pesquisa / updated_pesquisa: **0** / **0**
- skipped: **0**
- errors: **0**
- review_candidates_ignored: **0**
- arrays_normalized_count: **20**
