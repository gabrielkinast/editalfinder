...
- Execução: `2026-05-19T21:20:43Z`
- Modo: **apply**
- Fonte: `darpa_programs_research`
- Wave: `—`
- Payload notícia: `audit_reports_news_research\darpa_programs_subset_validostaging=staging\darpa_programs_payload_noticia.json`
- Payload pesquisa: `audit_reports_news_research\darpa_programs_subset_validostaging=staging\standardized\darpa_programs_research_standardized.json`
- Review (auditoria, não carregado): `audit_reports_news_research\darpa_programs_subset_validostaging=staging\darpa_programs_review_candidates.json`
- Diretório: `D:\Computational_Physics\My Projects\edital\audit_reports_news_research\darpa_programs_subset_validostaging=staging`
