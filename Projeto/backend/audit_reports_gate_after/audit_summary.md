...
|---------|-----------|--------|-----------|-------|
| aneel|aneel_editais.json | energia | maduro | alta | baixo |
| bndes|bndes_editais.json | credito | maduro | alta | baixo |
| cnpq|cnpq_editais.json | fomento | maduro | alta | baixo |
| finep|finep_editais.json | fomento | maduro | alta | baixo |
