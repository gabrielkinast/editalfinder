# EurekAlert Wave 1 — validação pós-carga

- Gerado: `2026-05-09T06:13:35Z`
- Staging: **True**
- Fonte / onda: `eurekalert_science_filtered` / `eurekalert_wave1`
- Resultado global: **FALHOU**
...
- **eurekalert_esperado_0_noticia_3_pesquisa_0_review_0_rejected**: FALHOU
  - Detalhe: `{"noticia_payload": 0, "pesquisa_payload": 1, "review_json": 0, "rejected_json": 0}`
- **eurekalert_fonte_experimental_em_config**: OK
- **eurekalert_bio_agro_sem_defesa_militar_indevida**: OK
- **eurekalert_fonte_recurso_bd**: OK
- **eurekalert_extras_eurekalert_filtered**: OK
...
- Alinhado (source + wave + would_upsert): **True**
- Ficheiro: `D:\Computational_Physics\My Projects\edital\audit_reports_news_research_loader\load_news_research_summary.json`

## Ficheiro JSON

- `eurekalert_wave1_post_load_validation.json`

```json
{
  "gerado_em": "2026-05-09T06:13:35Z",
  "staging_flag": true,
  "source": "eurekalert_science_filtered",
  "wave": "eurekalert_wave1",
  "payload_paths": {
    "noticia": "D:\\Computational_Physics\\My Projects\\edital\\audit_reports_news_research_loader\\eurekalert_wave1_payload_noticia.json",
    "pesquisa": "D:\\Computational_Physics\\My Projects\\edital\\audit_reports_news_research_loader\\eurekalert_wave1_payload_pesquisa.json",
    "review": "D:\\Computational_Physics\\My Projects\\edital\\audit_reports_news_research_loader\\eurekalert_wave1_review_candidates.json",
    "rejected": "D:\\Computational_Physics\\My Projects\\edital\\audit_reports_news_research_loader\\eurekalert_wave1_rejected.json"
  },
  "expected_counts": {
    "noticia": 0,
    "pesquisa": 1,
  ...
  "checks": [
    ...
    },
    {
      ...
      "ok": true,
      "detail": {
        "path": "D:\\Computational_Physics\\My Projects\\edital\\audit_reports_news_research_loader\\eurekalert_wave1_review_candidates.json",
        "count": 0
      }
    },
    {
      ...
      "ok": true,
      "detail": {
        "path": "D:\\Computational_Physics\\My Projects\\edital\\audit_reports_news_research_loader\\eurekalert_wave1_rejected.json",
        "count": 0
      }
    },
    {
    ...
    {
      "name": "eurekalert_esperado_0_noticia_3_pesquisa_0_review_0_rejected",
      "ok": false,
      "detail": {
        "noticia_payload": 0,
        "pesquisa_payload": 1,
    ...
    {
      "name": "eurekalert_fonte_experimental_em_config",
      "ok": true,
      "detail": {
        "status": "experimental_wave",
        "config": "D:\\Computational_Physics\\My Projects\\edital\\config\\news_research_sources.json"
      }
    },
    {
      "name": "eurekalert_bio_agro_sem_defesa_militar_indevida",
      "ok": true,
      "detail": {
        "links": [],
    ...
    {
      "name": "eurekalert_fonte_recurso_bd",
      "ok": true,
      "detail": {
        "esperado": "eurekalert_science_filtered",
        "links_errados": []
      }
    },
    {
      "name": "eurekalert_extras_eurekalert_filtered",
      "ok": true,
      "detail": {
        "sem_flag": []
      }
    },
    {
      ...
      "ok": true,
      "detail": {
        "detail": "sem_links_noticia_no_payload"
      }
    },
    {
  ...
  "output_paths": {
    "json": "D:\\Computational_Physics\\My Projects\\edital\\audit_reports_news_research_loader\\eurekalert_wave1_post_load_validation.json",
    "markdown": "D:\\Computational_Physics\\My Projects\\edital\\audit_reports_news_research_loader\\eurekalert_wave1_post_load_validation.md"
  }
}
```
