# NASA Wave 2 — validação pós-carga

- Gerado: `2026-05-09T06:13:15Z`
- Staging: **True**
- Fonte / onda: `nasa_news` / `nasa_wave2`
- Resultado global: **OK**
...
- `nasa_wave2_post_load_validation.json`

```json
{
  "gerado_em": "2026-05-09T06:13:15Z",
  "staging_flag": true,
  "source": "nasa_news",
  "wave": "nasa_wave2",
  "payload_paths": {
    "noticia": "D:\\Computational_Physics\\My Projects\\edital\\audit_reports_news_research_loader\\nasa_wave2_payload_noticia.json",
    "pesquisa": "D:\\Computational_Physics\\My Projects\\edital\\audit_reports_news_research_loader\\nasa_wave2_payload_pesquisa.json",
    "review": "D:\\Computational_Physics\\My Projects\\edital\\audit_reports_news_research_loader\\nasa_wave2_review_candidates.json",
    "rejected": ""
  },
  "expected_counts": {
    "noticia": 76,
  ...
  "checks": [
    ...
    },
    {
      ...
      "ok": true,
      "detail": {
        "path": "D:\\Computational_Physics\\My Projects\\edital\\audit_reports_news_research_loader\\nasa_wave2_review_candidates.json",
        "count": 0
      }
    },
    {
  ...
  "loader_summary_alignment": {
    ...
    "expected_noticia": 76,
    "expected_pesquisa": 19,
    "nota": "Referência ao último load_news_research_summary.json; pode não coincidir se a última execução foi outra fonte/onda."
  },
  "output_paths": {
    "json": "D:\\Computational_Physics\\My Projects\\edital\\audit_reports_news_research_loader\\nasa_wave2_post_load_validation.json",
    "markdown": "D:\\Computational_Physics\\My Projects\\edital\\audit_reports_news_research_loader\\nasa_wave2_post_load_validation.md"
  }
}
```
