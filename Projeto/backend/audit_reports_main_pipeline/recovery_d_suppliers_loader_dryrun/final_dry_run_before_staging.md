...
- Slice derivado (relatório): `D:\Computational_Physics\My Projects\edital\audit_reports_main_pipeline\recovery_d_suppliers_loader_dryrun\readiness_derived_slice.json`
- Fontes selecionadas: **3**
- Fontes excluídas: **0**
- Itens standardized: **28**
- Destinos: `{'edital': 22, 'pesquisa': 2, 'noticia': 4}`
- Upsert simulado: **28**
...
- Itens com documentos na entrada: **19**
- Itens com documentos preservados: **19**
...
- Itens com pdf_url na entrada: **19**
- Itens com pdf_url preservado: **19**
- Itens com validacao_status preservado: **22**
- Itens com qualidade_dado preservada: **22**
