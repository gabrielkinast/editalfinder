...
Gerado: `2026-05-01T06:34:20Z` · Amostra: até **25** itens por ficheiro · PDF: **on**.
...
- Distribuição heurística de maturidade: {'fraco': 2, 'quebrado': 2}.
...
|---------------------------|---------------------|
| Relevancia limite: poucos sinais de oportunidade | 56 |
| Pontuacao abaixo do minimo (oportunidade nao evidenciada) | 8 |
...
- **tipo_oportunidade**: score acumulado 200
- **area**: score acumulado 200
- **perfil_ideal**: score acumulado 200
- **setor_economico**: score acumulado 200
- **area_cientifica**: score acumulado 200
- **area_tecnologica**: score acumulado 200
- **setor_estrategico**: score acumulado 200
- **documentos**: score acumulado 200
- **fim_inscricao**: score acumulado 100
- **publico_alvo**: score acumulado 67
- **data_publicacao**: score acumulado 33
- **valor**: score acumulado 33
...
## 12. Datas
- **0** flags em `audit_by_source.json` (por fonte) + agregado nos exemplos.
...
- **Maduro** (exemplos): —
- **Ruidoso**: —
- **Quebrado** (0 aceites ou erro): 2 fontes — primeiras: bndes, cnpq
